...
Open pixel-sorter.html in any modern web browser (Chrome or Edge recommended for best WebM codec support).

Drag and drop an image or click the workspace to upload.

Choose to "Scale to Screen" for maximum performance or "Keep Original" for high-res exports.

Click "Start Sort" to preview the effect.

Click "Record Sort" to generate a video file including 1-second static intro/outro buffers.

Hover over the status bar during or after the process to view detailed performance statistics.
